...
toggler.addEventListener("click", function () {
  ...
  console.log(logo);
  if (open) {
    logo.src = "https://brandslogos.com/wp-content/uploads/images/large/subway-logo-3.png";
    hamburger.classList.add("nav-toggler-alt");
    togglerLinks.classList.add("show-nav");
  } else {
    logo.src = "https://www.freepnglogos.com/uploads/subway-png-logo/subway-launches-refreshed-logo-png-12.png";
